...
$files =
  {
   ...
   'en/help/admin_config'                             => ['introduction to list configuration',       'us-ascii', '7bit'],
   'en/help/admin_delivery'                           => ['introduction to the delivery process',     'us-ascii', '7bit'],
   'en/help/admin_documents'                          => ['introduction to file space management',    'us-ascii', '7bit'],
   'en/help/admin_domain'                             => ['virtual domains in Majordomo 2 ',          'us-ascii', '7bit'],
   'en/help/admin_passwords'                          => ['administrative reference for passwords',   'us-ascii', '7bit'],
   'en/help/admin_moderate'                           => ['introduction to list moderation',          'us-ascii', '7bit'],
   'en/help/admin_monitor'                            => ['introduction to logging and reporting',    'us-ascii', '7bit'],
   'en/help/admin_subscribers'                        => ['introduction to subscriber management',    'us-ascii', '7bit'],
   ...
   'en/help/command_parser'                           => ['overview of the command parser',           'us-ascii', '7bit'],
   ...
   'en/help/configset_wwwadm_url'                     => ['detailed help for configset GLOBAL',       'us-ascii', '7bit'],
   'en/help/configset_wwwusr_url'                     => ['detailed help for configset GLOBAL',       'us-ascii', '7bit'],
   ...
   'en/help/error_files'                              => ['description of Majordomo error files',     'us-ascii', '7bit'],
   'en/help/exit'                                     => ['alias help file',                          'us-ascii', '7bit'],
   'en/help/faq'                                      => ['detailed help for faq command',            'us-ascii', '7bit'],
   'en/help/foot'                                     => ['generic footer for the help command',      'us-ascii', '7bit'],
   ...
   'en/help/mj_confirm'                               => ['detailed help for WWW interfaces',         'us-ascii', '7bit'],
   'en/help/mj_shell'                                 => ['man page for mj_shell',                    'us-ascii', '7bit'],
   'en/help/mj_wwwadm'                                => ['detailed help for WWW interfaces',         'us-ascii', '7bit'],
   'en/help/mj_wwwusr'                                => ['detailed help for WWW interfaces',         'us-ascii', '7bit'],
   ...
   'en/help/reply_files'                              => ['description of Majordomo reply files',     'us-ascii', '7bit'],
   ...
   'en/config/wwwadm_url'                      => ['The wwwadm_url variable',                     'us-ascii', '7bit'],
   'en/config/wwwusr_url'                      => ['The wwwusr_url variable',                     'us-ascii', '7bit'],
