  ...
  (
   ...
   'createlist' =>
   {
    ...
    'dispatch' => {'top' => 1, 
                   ...
                   'modes'    =>  {
                                   %generic_modes,
                                   'destroy'     => {'exclude' => 'force|inactive|noarchive|nocreate|nowelcome|pass|regen|rename'},
                                   'force'       => 1,
                                   'inactive'    => 1,
                                   'noarchive'   => 1,
                                   'nocreate'    => {'exclude' => 'force|inactive|noarchive|nowelcome|pass|regen|rename'},
                                   'nowelcome'   => 1,
                                   'pass'        => 1,
                                   'regen'       => {'exclude' => 'force|inactive|noarchive|nowelcome|pass|rename'},
                                   'rename'      => {'exclude' => 'force|inactive|noarchive|nowelcome|pass'},
                                  },
   ...
   'post' =>
   {
    ...
    'access'   => {
		    ...
		    'nonempty_lines'               => 'integer',
                    ...
                    'post_block'                   => 'bool',
		    'posts'                        => 'integer',
		    'posts_last_24hours'           => 'integer',
		    'posts_last_7days'             => 'integer',
		    'posts_last_30days'            => 'integer',
		    'posts_this_day'               => 'integer',
