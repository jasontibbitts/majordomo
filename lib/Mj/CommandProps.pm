...
%Mj::CommandProps::access_vars_desc_en = (
        ...
        'body_length_exceeded' => "is set if 'bytes' exceeds the value in 'configset LISTNAME maxlength'",
                       'bytes' => "contains the actual byte count of the message, see 'body_length_exceeded' for test",
        ...
        'dup_partial_checksum' => "is set if the checksum of the first ten lines of the message has been seen before",
           ...
           'max_header_length' => "contains the length of the longest header in the message, see 'max_header_length_exceeded' for test",
  'max_header_length_exceeded' => "is set if 'max_header_length' exceeds the value in 'configset LISTNAME max_header_line_length'",
          ...
          'mime_header_length' => "contains the length of the longest MIME header in the message, see 'mime_header_length_exceeded' for test",
